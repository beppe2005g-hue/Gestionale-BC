...
const SEZIONI = [
  ...
  { key: 'perm_cantieri',                label: 'Cantieri',               icon: '🏗️', section: 'Principale' },
  { key: 'perm_cassa_edile',             label: 'Cassa Edile',            icon: '🏗️', section: 'Principale' },
  ...
  { key: 'perm_scadenze_aziendali',      label: 'Scadenze aziendali',     icon: '⏰', section: 'Controllo' },
...
const PRESETS: Record<string, Record<string, boolean>> = {
  ...
  geometra: {
    ...
    perm_presenze: true, perm_cantieri: true, perm_cassa_edile: true,
